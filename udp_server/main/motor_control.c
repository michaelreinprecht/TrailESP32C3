...
void drive_forward(uint8_t duty_cycle_motor)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);

    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_2, duty_cycle_motor);
...
void drive_right(uint8_t duty_cycle_motor1, uint8_t duty_cycle_motor2)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor1);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);

    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_2, duty_cycle_motor2);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_2);
...
void drive_backward(uint8_t duty_cycle_motor)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);
...
void drive_left(uint8_t duty_cycle_motor1, uint8_t duty_cycle_motor2)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor1);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);
...
void drive_forward_diagonally(uint8_t duty_cycle_motor1, uint8_t duty_cycle_motor2)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor1);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);
...
void drive_backward_diagonally(uint8_t duty_cycle_motor1, uint8_t duty_cycle_motor2)
{
    ledc_set_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1, duty_cycle_motor1);
    ledc_update_duty(LEDC_LOW_SPEED_MODE, PWM_CHANNEL_1);
